...
/* mutex */
#define PoolMutex  pthread_mutex_t
#define PoolMutexAttr pthread_mutexattr_t
#define PoolMutexInit(mut, mutattr ) pthread_mutex_init(mut, mutattr)
#define PoolMutexLock(mut) pthread_mutex_lock(mut)
#define PoolMutexTrylock(mut) pthread_mutex_trylock(mut)
#define PoolMutexUnlock(mut) pthread_mutex_unlock(mut)
#define PoolMutexDestroy pthread_mutex_destroy
#define POOLMUTEX_INITIALIZER PTHREAD_MUTEX_INITIALIZER


struct PoolThreadElement_ {
    PoolMutex lock;                   /**< lock, should have low contention */
